...
test.describe("Authentication", () => {
	...
	test("should show validation errors on empty register form", async ({
		page,
	}) => {
		await page.goto("/register");
	...
	test("should login successfully and redirect to videos page", async ({
		page,
	}) => {
	...
	test("should redirect to login when accessing upload page without auth", async ({
		page,
	}) => {
